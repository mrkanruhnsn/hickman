	...
	<div class="sb-onboarding-wizard-sources-list sb-fs">
		...
		<div class="sb-onboarding-wizard-source-item sb-fs" v-for="source in sourcesList">
			<div class="sb-onboarding-wizard-source-item-avatar">
				...
				<svg viewbox="0 0 12 13" width="16" fill="#1778F2" style="background: #fff; border-radius: 50px;"><path d="M11.8125 6.5C11.8125 3.28906 9.21094 0.6875 6 0.6875C2.78906 0.6875 0.1875 3.28906 0.1875 6.5C0.1875 9.40625 2.29688 11.8203 5.08594 12.2422V8.1875H3.60938V6.5H5.08594V5.23438C5.08594 3.78125 5.95312 2.96094 7.26562 2.96094C7.92188 2.96094 8.57812 3.07812 8.57812 3.07812V4.50781H7.85156C7.125 4.50781 6.89062 4.95312 6.89062 5.42188V6.5H8.50781L8.25 8.1875H6.89062V12.2422C9.67969 11.8203 11.8125 9.40625 11.8125 6.5Z"></path></svg>
			</div>
