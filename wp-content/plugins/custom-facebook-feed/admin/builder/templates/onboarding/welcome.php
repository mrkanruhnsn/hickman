<div class="sb-onboarding-wizard-step-wrapper sb-onboarding-wizard-step-welcome sb-fs">
	<div class="sb-onboarding-wizard-welcome-text sb-fs">
		...
		<div class="sb-onboarding-wizard-welcome-btns">
			<button class="sb-btn cff-btn-blue sb-btn-wizard-next" v-html="onboardingWizardStepContent['welcome'].button" @click.prevent.default="nextWizardStep"></button>
			<a class="sb-btn cff-btn-grey" v-html="genericText.learnMore" @click.prevent.default="nextWizardStep"></a>
		</div>
	</div>
