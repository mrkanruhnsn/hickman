        ...
        <div class="cff-dummy-lightbox-modal">
            <div class="cff-dummy-lightbox-modal-content">
                <div class="cff-dlm-left">
                    <img src="CFF_BUILDER_URLassets/img/cff-dummy-lightbox-preview-img.png" alt="dummy lightbox preview">
                <\/div>
                <div class="cff-dlm-right">
                    ...
                    <div class="cff-dlm-reactions-bar">
                        <img src="CFF_BUILDER_URLassets/img/cff-lightbox-reactions-bar.png" alt="dummy lightbox preview">
                    <\/div>
                <\/div>
            <\/div>
