	...
	<div class="cff-fb-section-wh-insd cff-fb-fs">
		...
		<div class="cff-fb-sglelm-right">
			<div class="cff-fb-sglelm-img-ctn cff-fb-sglelm-img-pf" v-if="!featuredPostFeedInfo.isError && !featuredPostFeedInfo.success">
				<img src="https://mrkanruhnsn.github.io/hickman//wp-content/plugins/custom-facebook-feed/admin/builder/templates/sections/create-feed/CFF_BUILDER_URLassets/img/process-featured-post.png" alt="Fetching Preview">
			...
			<div class="cff-fb-sglelm-img-ctn cff-fb-sglelm-img-errorctn" v-if="featuredPostFeedInfo.isError">
				<img src="https://mrkanruhnsn.github.io/hickman//wp-content/plugins/custom-facebook-feed/admin/builder/templates/sections/create-feed/CFF_BUILDER_URLassets/img/process-error-fetch.png" alt="Preview Error">
