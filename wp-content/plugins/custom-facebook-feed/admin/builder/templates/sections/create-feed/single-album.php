	...
	<div class="cff-fb-section-wh-insd cff-fb-fs">
		...
		<div class="cff-fb-sglelm-right">
			<div class="cff-fb-sglelm-img-ctn" v-if="!singleAlbumFeedInfo.isError && !singleAlbumFeedInfo.success">
				<img src="https://mrkanruhnsn.github.io/hickman//wp-content/plugins/custom-facebook-feed/admin/builder/templates/sections/create-feed/CFF_BUILDER_URLassets/img/process-single-album.png" alt="Fetching Preview">
