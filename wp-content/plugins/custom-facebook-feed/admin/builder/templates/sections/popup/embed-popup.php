<div class="cff-fb-embed-ctn sb-fs-boss cff-fb-center-boss" v-if="viewsActive.embedPopup">
	<div class="cff-fb-embed-popup cff-fb-popup-inside">
		<div class="cff-fb-popup-cls" @click.prevent.default="activateView('embedPopup')">
<svg width="14" height="14" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="cff-fb-embed-step-1 cff-fb-fs" v-show="viewsActive.embedPopupScreen == 'step_1'">
			...
			<div class="cff-fb-embed-step-1-bottom cff-fb-fs">
              ...
              <svg width="7" height="10" viewbox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.83516 0L0.660156 1.175L4.47682 5L0.660156 8.825L1.83516 10L6.83516 5L1.83516 0Z" fill="#141B38"></path>
              </svg>
		...
		<div class="cff-fb-embed-step-2 cff-fb-fs" v-show="viewsActive.embedPopupScreen == 'step_2'">
          ...
          <svg width="16" height="12" viewbox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M5.58058 8.36158L13.5355 0.406627L15.3033 2.17439L5.58058 11.8971L0.277281 6.59381L2.04505 4.82604L5.58058 8.36158Z" fill="currentColor"></path>
          </svg>
