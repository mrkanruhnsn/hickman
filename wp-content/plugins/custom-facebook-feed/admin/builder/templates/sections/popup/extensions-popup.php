        ...
        <div>
            <div class="cff-fb-extpp-top cff-fb-fs" :class="iscustomizerScreen && customizerScreens.popupBackButton.includes(viewsActive.extensionsPopupElement) ? 'cff-fb-extpp-top-fdtype' : ''">
                <div class="cff-fb-extpp-info">
                    <div v-if="iscustomizerScreen && customizerScreens.popupBackButton.includes(viewsActive.extensionsPopupElement)" class="cff-fb-slctf-back cff-fb-hd-btn cff-btn-grey" @click.prevent.default="viewsActive.extensionsPopupElement == 'feedTemplates' ? activateView('feedtemplatesPopupCustomizer')  : activateView('feedtypesPopup')">
<svg width="7" height="11" viewbox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.3415 1.18184L5.1665 0.00683594L0.166504 5.00684L5.1665 10.0068L6.3415 8.83184L2.52484 5.00684L6.3415 1.18184Z" fill="#141B38"></path></svg> <span>Back</span>
            ...
            <div class="cff-fb-extpp-bottom cff-fb-fs">
                ...
                <div class="cff-fb-extpp-btns cff-fb-fs">
                    <a class="cff-fb-extpp-get-btn cff-btn-orange" :href="extensionsPopup[viewsActive.extensionsPopupElement].buyUrl" target="_blank" v-html="viewsActive.extensionsPopupElement == 'socialwall' ? genericText.seeTheDemo : genericText.seeProDemo"></a>
                </div>
            </div>
        </div>
    </div>
