		...
		<div class="cff-fb-srcslist-ctn cff-fb-fs">
			<div class="cff-fb-srcs-item cff-fb-srcs-new" @click.prevent.default="activateView('sourcePopup','creationRedirect')">
                <svg width="10" height="10" viewbox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.66634 5.66634H5.66634V9.66634H4.33301V5.66634H0.333008V4.33301H4.33301V0.333008H5.66634V4.33301H9.66634V5.66634Z" fill="#0096CC"></path>
                </svg>
                        ...
                        <span>
                            ...
                            <div class="sb-group-small-notice" v-if="source?.account_type === 'group' && !checkTypeForGroup(source)">
                                <svg width="16" height="16" viewbox="0 0 13 13" fill="none">
								    <path d="M6.50008 0.666664C3.28008 0.666664 0.666748 3.28 0.666748 6.5C0.666748 9.72 3.28008 12.3333 6.50008 12.3333C9.72008 12.3333 12.3334 9.72 12.3334 6.5C12.3334 3.28 9.72008 0.666664 6.50008 0.666664ZM7.08342 9.41667H5.91675V8.25H7.08342V9.41667ZM7.08342 7.08333H5.91675V3.58333H7.08342V7.08333Z" fill="#D72C2C"></path>
								</svg>
	...
	<div class="cff-fb-mr-fd-img">
        <svg width="335" height="185" viewbox="0 0 335 185" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0)">
                <rect width="335" height="185" fill="white"></rect>
                <g opacity="0.3" filter="url(#filter0_f)">
                    <circle cx="128.5" cy="188.5" r="129.5" fill="#1B90EF"></circle>
                </g>
                <g opacity="0.1" filter="url(#filter1_f)">
                    <circle cx="58.5" cy="28.5" r="129.5" fill="url(#paint0_linear)"></circle>
                </g>
                <g filter="url(#filter2_d)">
                    <rect x="85.6269" y="-79.76" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 85.6269 -79.76)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    <g clip-path="url(#clip1)">
                        <rect x="81.6348" y="-65.6123" width="98.7775" height="50.1727" transform="rotate(15 81.6348 -65.6123)" fill="#EFADAD"></rect>
                    </g>
                    <rect x="66.411" y="-8.04512" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 66.411 -8.04512)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    <path d="M155.224 22.4831C155.651 22.312 156.056 22.0782 156.404 21.772C156.047 21.8284 155.645 21.835 155.263 21.7707C155.715 21.6446 156.095 21.3657 156.355 20.9601C155.943 21.0779 155.492 21.1283 155.06 21.1076C154.805 20.6398 154.383 20.2985 153.851 20.1558C152.821 19.88 151.764 20.4906 151.488 21.52C151.45 21.662 151.43 21.8087 151.427 21.9602C149.907 21.4577 148.722 20.3414 148.099 18.976C147.868 19.1994 147.693 19.4951 147.598 19.85C147.427 20.489 147.594 21.1425 148.019 21.6176C147.722 21.519 147.439 21.3672 147.229 21.1586L147.224 21.1764C146.981 22.0815 147.421 22.9981 148.225 23.4038C148.073 23.4013 147.886 23.3892 147.727 23.3464C147.603 23.3131 147.501 23.2669 147.381 23.2158C147.412 24.0231 147.962 24.741 148.773 24.9775C148.001 25.3032 147.122 25.3909 146.252 25.1579C146.093 25.1151 145.955 25.0593 145.818 25.0035C146.492 25.7547 147.387 26.318 148.452 26.6033C151.877 27.5211 154.497 25.1985 155.158 22.7316C155.182 22.6429 155.201 22.5719 155.224 22.4831Z" fill="#1B90EF"></path>
                    <circle cx="79.5038" cy="13.5211" r="9.01541" transform="rotate(15 79.5038 13.5211)" fill="#D0D1D7"></circle>
                    <rect x="66.0264" y="28.9824" width="80.7467" height="5.48764" rx="0.728392" transform="rotate(15 66.0264 28.9824)" fill="#D0D1D7"></rect>
                    <rect x="63.3896" y="38.8262" width="47.0369" height="5.48764" rx="0.728392" transform="rotate(15 63.3896 38.8262)" fill="#D0D1D7"></rect>
                    <rect x="47.1952" y="63.6697" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 47.1952 63.6697)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    ...
                    <rect x="42.7979" y="79.333" width="98.7775" height="48.6048" transform="rotate(15 42.7979 79.333)" fill="#FEF4EF"></rect>
                    <path d="M97.3184 93.9414L138.209 104.898L125.629 151.847L88.5936 126.503L97.3184 93.9414Z" fill="#FCE1D5"></path>
                    <path d="M97.3188 93.9419L42.7979 79.333L34.0731 111.894L88.5941 126.503L97.3188 93.9419Z" fill="#F9BBA0"></path>
                    <rect x="27.9794" y="135.386" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 27.9794 135.386)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    <path d="M116.792 165.914C117.218 165.743 117.623 165.509 117.972 165.203C117.614 165.259 117.213 165.266 116.831 165.201C117.283 165.075 117.662 164.796 117.923 164.391C117.511 164.509 117.06 164.559 116.628 164.538C116.373 164.07 115.951 163.729 115.418 163.586C114.389 163.311 113.331 163.921 113.055 164.951C113.017 165.093 112.997 165.239 112.994 165.391C111.474 164.888 110.29 163.772 109.666 162.407C109.435 162.63 109.261 162.926 109.166 163.281C108.995 163.92 109.162 164.573 109.586 165.048C109.289 164.95 109.007 164.798 108.796 164.589L108.791 164.607C108.549 165.512 108.988 166.429 109.792 166.835C109.641 166.832 109.454 166.82 109.294 166.777C109.17 166.744 109.068 166.698 108.949 166.646C108.98 167.454 109.529 168.172 110.341 168.408C109.569 168.734 108.689 168.822 107.82 168.589C107.66 168.546 107.523 168.49 107.385 168.434C108.059 169.185 108.954 169.749 110.019 170.034C113.445 170.952 116.064 168.629 116.725 166.162C116.749 166.074 116.768 166.003 116.792 165.914Z" fill="#1B90EF"></path>
                    <circle cx="41.0711" cy="156.952" r="9.01541" transform="rotate(15 41.0711 156.952)" fill="#D0D1D7"></circle>
                    <rect x="27.5947" y="172.413" width="80.7467" height="5.48764" rx="0.728392" transform="rotate(15 27.5947 172.413)" fill="#D0D1D7"></rect>
                    <rect x="24.957" y="182.257" width="47.0369" height="5.48764" rx="0.728392" transform="rotate(15 24.957 182.257)" fill="#D0D1D7"></rect>
                </g>
                <g filter="url(#filter3_d)">
                    <rect x="195.769" y="-73.092" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 195.769 -73.092)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    <rect x="191.37" y="-57.4287" width="98.7775" height="48.6048" transform="rotate(15 191.37 -57.4287)" fill="#FEF4EF"></rect>
                    <path d="M245.892 -42.8203L286.782 -31.8637L274.203 15.085L237.167 -10.2592L245.892 -42.8203Z" fill="#FCE1D5"></path>
                    <rect x="176.554" y="-1.37618" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 176.554 -1.37618)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    ...
                    <rect x="172.154" y="14.2852" width="98.7775" height="48.6048" transform="rotate(15 172.154 14.2852)" fill="#FEF4EF"></rect>
                    <path d="M226.673 28.8936L267.564 39.8502L254.984 86.7988L217.948 61.4547L226.673 28.8936Z" fill="#FCE1D5"></path>
                    <path d="M226.675 28.894L172.154 14.2852L163.43 46.8463L217.951 61.4552L226.675 28.894Z" fill="#F9BBA0"></path>
                    <rect x="157.337" y="70.3387" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 157.337 70.3387)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    <path d="M246.769 98.8958C246.776 98.4413 246.529 98.0138 246.15 97.7979C245.444 97.3804 242.426 96.572 242.426 96.572C242.426 96.572 239.392 95.7588 238.571 95.7673C238.135 95.7644 237.707 96.0113 237.486 96.4087C237.074 97.097 236.646 98.6943 236.646 98.6943C236.646 98.6943 236.223 100.274 236.231 101.094C236.223 101.549 236.475 101.958 236.855 102.174C237.565 102.574 240.6 103.387 240.6 103.387C240.6 103.387 243.617 104.196 244.433 104.205C244.87 104.208 245.292 103.979 245.513 103.581C245.931 102.875 246.354 101.296 246.354 101.296C246.354 101.296 246.782 99.6983 246.769 98.8958ZM240.13 101.169L240.9 98.2934L243.035 100.406L240.13 101.169Z" fill="#EB2121"></path>
                    <g clip-path="url(#clip2)">
                        <rect x="153.345" y="84.4863" width="98.7775" height="50.1727" transform="rotate(15 153.345 84.4863)" fill="#EFADAD"></rect>
                        <path d="M191.49 108.726L206.118 122.975L186.325 128.002L191.49 108.726Z" fill="white"></path>
                    </g>
                    <rect x="138.121" y="142.054" width="98.3855" height="64.6757" rx="1.37191" transform="rotate(15 138.121 142.054)" fill="white" stroke="#E8E8EB" stroke-width="0.391974"></rect>
                    ...
                    <circle cx="151.213" cy="163.62" r="9.01541" transform="rotate(15 151.213 163.62)" fill="#D0D1D7"></circle>
                    <rect x="137.735" y="179.081" width="80.7467" height="5.48764" rx="0.728392" transform="rotate(15 137.735 179.081)" fill="#D0D1D7"></rect>
                </g>
            </g>
            <defs>
                ...
                <filter id="filter2_d" x="5.17286" y="-85.0987" width="181.555" height="315.216" filterunits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    ...
                    <feoffset dy="0.728392"></feoffset>
                    <fegaussianblur stddeviation="2.91357"></fegaussianblur>
                ...
                <clippath id="clip1">
                    <rect width="98.7775" height="50.1727" fill="white" transform="translate(81.6348 -65.6123) rotate(15)"></rect>
                </clippath>
                <clippath id="clip2">
                    <rect width="98.7775" height="50.1727" fill="white" transform="translate(153.345 84.4863) rotate(15)"></rect>
                </clippath>
            </defs>
        </svg>
			...
			<button class="cff-btn-grey cff-fb-mr-fd-item" v-for="(plugin, pluginName, platIndex) in plugins" @click.prevent.default="activateViewOrRedirect('installPluginPopup', pluginName, plugin)">
				...
				<div class="cff-fb-mr-fd-ch">
                    <svg width="7" height="10" viewbox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.3332 0L0.158203 1.175L3.97487 5L0.158203 8.825L1.3332 10L6.3332 5L1.3332 0Z" fill="#141B38"></path>
                    </svg>
                </div>
			</button>
		</div>
