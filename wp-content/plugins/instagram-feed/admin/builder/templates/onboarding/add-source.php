...
<div class="sb-onboarding-wizard-step-pag-btns sb-fs">
	<button class="sb-btn sbi-btn-grey sb-btn-wizard-next" v-if="sourcesList.length === 0" v-html="'Skip this step'" @click.prevent.default="nextWizardStep"></button>
	<button class="sb-btn sbi-btn-blue sb-btn-wizard-next" v-if="sourcesList.length >= 1" v-html="'Next'" @click.prevent.default="nextWizardStep"></button>
</div>