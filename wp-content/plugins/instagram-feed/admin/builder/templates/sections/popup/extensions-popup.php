        ...
        <div>
            <div class="sbi-fb-extpp-top sbi-fb-fs">
                <div class="sbi-fb-extpp-info">
                    ...
                    <div class="sbi-fb-fs">
                        <div class="sbi-fb-extpp-lite-btn" target="_blank" v-if="customizerScreens.popupBackButton.includes(viewsActive.extensionsPopupElement)">
            ...
            <div class="sbi-fb-extpp-bottom sbi-fb-fs">
                ...
                <div class="sbi-fb-extpp-btns sbi-fb-fs">
                    <a class="sbi-fb-extpp-get-btn sbi-btn-orange" :href="extensionsPopup[viewsActive.extensionsPopupElement].buyUrl" target="_blank">{{genericText.upgrade}}</a>
                </div>
            </div>
        </div>
	</div>
